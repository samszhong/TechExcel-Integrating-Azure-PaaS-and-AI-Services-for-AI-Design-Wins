...
public class DatabaseService : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get a specific hotel.")]
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")]int hotelId, [Description("Date and Time")]DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Book Missing Hotel Room.")] 
    ...
    [KernelFunction]
    [Description("Book Multiple Hotel Room.")] 
